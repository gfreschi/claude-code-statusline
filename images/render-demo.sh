...
# Frozen wall clock matches test/run.sh's TEST_NOW so the rate-limit
# time-remaining text is deterministic across GIF regens. Each JSON
# payload below carries resets_at values relative to this epoch.
